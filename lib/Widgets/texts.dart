  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(
        ...
        " \n organization and content of a CV depends on the type of position you apply"
        "  \n for. When organizing your CV, list the most relevant sections first to catch an"
        " employer's attention, whether that is your work history or an impressive list"
        "\n of publications. Here’s a CV template to reference when creating your own:",
        style: TextStyle(
            fontSize: 24,
            fontWeight: FontWeight.bold,
            color: Color.fromARGB(255, 26, 25, 25)),
